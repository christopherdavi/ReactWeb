...
const Formobs = () => {
    return (
        ...
        <h1 class="font-serif text-4xl"> OBSOLETO </h1> 
        ...
        <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="title" type="text" placeholder="Estado"></input>
